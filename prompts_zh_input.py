data = [
  {
    "act": "担任英语词源专家",
    "prompt": "我想让你充当英语词源专家。我将输入英语单词或者词组，请首先逐个单词给出其发音、含义、单词来源、词根分解，并以表格方式输出。最后给出词组的中文解释。",
    "cmd": "en_root",
    "use_chinese": True,
  ...
  {
    "act": "回答什么是...",
    "prompt": "我将输入一个名词或者概念，请回答这个名词或者概念是什么，并举例说明。列举概念的特性和应用，并给出特性和应用的示例说明。回答中的关键术语和名词用加粗字体显示，程序代码用代码格式显示，数学符号用LaTex显示。如无特殊说明，请用中文回答。请确保内联公式和独立公式均正确显示。",
    "cmd": "what_is",
    "use_chinese": True,
    "common_format_on": True,
    "tags": [
